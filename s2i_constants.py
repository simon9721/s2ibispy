...
class ConstantStuff:
    ...
    class SpiceType(IntEnum):
        ...
        SPECTRE = 4
        ELDO = 5
        # (Original Java had PSPICE=1, SPICE2=2, SPICE3=3; omitted here intentionally.)
    ...
    # ---------------------------
    # VI + Series VI (unchanged from before if you already matched Java)
    ...
    "ddn", "ddx", "vit", "vin", "vix")
    VT_PREFIXES = ("a", "b", "c", "x", "y", "z")  # rising: a/b/c, falling: x/y/z

    # ---------------------------
    # SPICE output markers (HSPICE-oriented; keep as hints)
    # ---------------------------
